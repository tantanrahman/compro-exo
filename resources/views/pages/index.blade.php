    ...
    <body id="page-top">
        ...
        <hr style="border: none; height: 2px; width: 100%; height: 2px; margin-top: 0; border-bottom: 0px solid #1f1209; box-shadow: 0 20px 20px -20px #000;">
        <img src="{{ asset('assets/img/batik.jpg') }}" style="position: relative; width: 100%; height:auto; margin-top:0%;margin-bottom:-80%; z-index:-1; opacity:0.2;">
        <section style="box-shadow: 0 2px 12px 2px gray; width:75%; margin: auto; border-radius: 10px;" data-aos="zoom-in" id="cek-resi">
            <div class="text-center">
                <div class="py-5" style="margin: 4%">

                    <h4 class="text-center mt-0" style="font-family: gotham;">Cek <font style="color: #008BD0"><b>Resi</b></h4></font>
        ...
        <marquee direction="left">
            <img src="{{ asset('assets/img/plane2.png') }}" width="200" height="80" />
        </marquee>
        <img src="{{ asset('assets/img/back_city.png') }}" style="position: relative; width: 100%; height:auto; margin-top:0%;margin-bottom:0%; z-index:1;">
        <!-- Portfolio-->
        <iframe
